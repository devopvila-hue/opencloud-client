 ...
 * Google "G" is a multi-colour brand mark we render inline so we
 * don't have to ship a binary asset.
 *
 * Used by LoginPage and SignupPage. Kept in its own file so both
 * screens share the exact same SVG.
 */
