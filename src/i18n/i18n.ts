...
export const catalog: Catalog = {
  ...
  // ── Login: Google + forgot + humanised errors ─────────────
  'login.google.cta':           ['Continue with Google', 'Continuar con Google'],
  'login.divider':              ['or with email', 'o con email'],
  'login.forgot.link':          ['Forgot your password?', '¿Olvidaste tu contraseña?'],
  'login.error.network':        ['Could not reach DEPARTIFY. Check your connection and try again.',
                                 'No pudimos conectar con DEPARTIFY. Revisa tu conexión e inténtalo de nuevo.'],
  'login.error.rate':           ['Too many attempts. Wait a moment and try again.',
                                 'Demasiados intentos. Espera un momento e inténtalo de nuevo.'],
  'login.error.invalid_credentials':['Email or password is incorrect.', 'El email o la contraseña no son correctos.'],
  'login.error.invalid_email':  ['That email does not look right.', 'Ese email no parece correcto.'],
  'login.error.weak_password':  ['Use at least 8 characters, with a number or symbol.',
                                 'Usa al menos 8 caracteres, con un número o un símbolo.'],
  'login.error.email_taken':    ['An account with that email already exists. Try signing in instead.',
                                 'Ya existe una cuenta con ese email. Prueba a iniciar sesión.'],
  'login.error.oauth_unavailable':['Google sign-in is not available right now. Use your email and password.',
                                    'El acceso con Google no está disponible ahora. Usa tu email y contraseña.'],
  'login.error.signup_generic': ['We could not create your account. Try again in a moment.',
                                 'No pudimos crear tu cuenta. Inténtalo de nuevo en un momento.'],
  'login.error.google_generic': ['Google sign-in failed. Try again or use your email and password.',
                                 'El acceso con Google falló. Inténtalo de nuevo o usa tu email y contraseña.'],
  'login.error.forgot_generic': ['We could not send the recovery email. Try again in a moment.',
                                 'No pudimos enviar el email de recuperación. Inténtalo de nuevo en un momento.'],

  // ── Forgot password page ──────────────────────────────────
  'forgot.title':               ['Recover access', 'Recupera el acceso'],
  'forgot.subtitle':            ['We will send you a link to reset your password.',
                                 'Te enviaremos un enlace para restablecer tu contraseña.'],
  'forgot.field.email':         ['Your email', 'Tu email'],
  'forgot.button.cta':          ['Send recovery link', 'Enviar enlace de recuperación'],
  'forgot.button.sending':      ['Sending…', 'Enviando…'],
  'forgot.hint':                ['The link expires in 30 minutes. If it does not arrive, check your spam folder.',
                                 'El enlace caduca en 30 minutos. Si no llega, revisa la carpeta de spam.'],
  'forgot.back_to_login':       ['Back to sign-in', 'Volver a iniciar sesión'],
  'forgot.sent.title':          ['Check your inbox', 'Revisa tu bandeja de entrada'],
  'forgot.sent.desc':           ['If that email matches an account, we have sent a recovery link. You can close this page now.',
                                 'Si ese email pertenece a una cuenta, hemos enviado un enlace de recuperación. Puedes cerrar esta página.'],
  ...
  'marketplace.hint.desc1':        ['A bundle of capabilities and policies ready to work for your company.',
                                   'Un paquete de capacidades y políticas listo para trabajar en tu empresa.'],
  'marketplace.hint.title2':       ['How do I install one?', '¿Cómo instalo una?'],
  'marketplace.hint.desc2':        ['Click Install. We provision the workspace, register the lead and run the first health check.',
                                   'Pulsa Instalar. Aprovisionamos el espacio, registramos al responsable y ejecutamos la primera comprobación de salud.'],
  ...
  'tasks.create_dialog.desc':    ['Send work to any department. The lead will run it with their team.',
                                 'Envía trabajo a cualquier departamento. El responsable lo ejecutará con su equipo.'],
  ...
  'marketplace.hint.what.desc':    ['A bundle of capabilities and policies ready to work for your company.',
  ...
  'marketplace.hint.how.desc':     ['Click Activate. We provision the workspace, register the lead and run the first health check.',
